...
<!-- 选择框内容 -->
		<div class="tab-pane active" id="panel-1">
							<div class="row-fluid">
								...
								<div style="width:70%;background:#f2f2f2;float:right">
									<h3>
										&nbsp;&nbsp;&nbsp;&nbsp;请认真阅读以下参赛须知
									</h3>
								</div>
...
<!-- 选择框结束! -->
						...
						<div class="span3" style="width:20%;border:1px solid #EAEAEA;float:right">
							<div class="row-fluid">
								<div id="d1" class="span12" style="padding-left:20px;background:#4876ff">
									<h3>
							...
							<br/>
							<div class="row-fluid">
								<!-- <div id="d6" class="span12" style="padding-left:20px;background:gray" onmouseout="this.style.backgroundColor='gray'" onmouseover="this.style.backgroundColor='#4876ff'"> -->
...
function goto1(){
	d1.style.backgroundColor="#4876ff";
...
function goto2(){
	d2.style.backgroundColor="#4876ff";
...
function goto3(){
	d3.style.backgroundColor="#4876ff";
	d1.style.backgroundColor="gray";
	d2.style.backgroundColor="gray";
	d4.style.backgroundColor="gray";
	d5.style.backgroundColor="gray";
...
function goto4(){
	d4.style.backgroundColor="#4876ff";
	d1.style.backgroundColor="gray";
	d2.style.backgroundColor="gray";
	d3.style.backgroundColor="gray";
	d5.style.backgroundColor="gray";
...
function goto5(){
	d5.style.backgroundColor="#4876ff";
	d1.style.backgroundColor="gray";
	d2.style.backgroundColor="gray";
	d3.style.backgroundColor="gray";
	d4.style.backgroundColor="gray";
...
function goto6(){
	d6.style.backgroundColor="#4876ff";
	d1.style.backgroundColor="gray";
	d2.style.backgroundColor="gray";
	d3.style.backgroundColor="gray";
	d4.style.backgroundColor="gray";
