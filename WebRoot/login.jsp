...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
      ...
      <ul class="nav navbar-nav">
		...
		<!-- 登录状态判断  -->
		<li><a href="register.jsp?#register">注册</a></li>
      </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
	...
	<!-- /Section: intro -->
	<!-- Section: apply -->
    <section id="apply" class="home-section text-center bg-gray">
		...
		<div class="logina-main main clearfix">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                <th>验证码</th>
                                <td width="245">
                                    <input id="password" type="password" name="password" placeholder="请输入验证码" autocomplete="off">
                                </td>
                                <td>picture</td>
                                <td>&nbsp &nbsp </td>
                                <td><a>换一张?</a></td>
            ...
            <div class="reg">
                ...
                <a class="reg-btn" href="register.jsp#register">立即注册</a>
            </div>
        </div>
